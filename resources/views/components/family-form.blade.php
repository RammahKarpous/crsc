<form class="form" action="{{ route($route, $method === 'put' ? $model->slug : '') }}" method="post">
    ...
    <div class="col-3 my-20">
        ...
        <div class="form__group">
            ...
            <input class="form__input form__input--text type="text" name="postcode" id="postcode" value="{{ $method === 'put' ? $model->postcode : '' }}">
    ...
    <div class="col-4">
        <div  class="form__group">
            ...
            <input class="form__input form__input--text type="text" name="contact_number" id="contact_number" value="{{ $method === 'put' ? $model->contact_number : '' }}">
